...
public class FaqTest extends DriverFactory {
    ...
    @Test
    public void testFaqQuestionExpandsWithCorrectText() {
        ...
        assertTrue("Ответ на вопрос " + questionIndex + " должен быть виден",
                mainPage.isFaqAnswerVisible(questionIndex));

        // Проверяем текст ответа
        String actualAnswer = mainPage.getFaqAnswerText(questionIndex);
        assertTrue("Ответ на вопрос " + questionIndex + " должен содержать: " + expectedAnswer +
